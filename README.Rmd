...
[10.5281/zenodo.22837936](https://doi.org/10.5281/zenodo.22837936). It resolves to
the most recently archived version, which is not necessarily the version you used
or the one that is currently on CRAN. To cite exactly what was used, take the DOI
of that version from the [Zenodo record](https://doi.org/10.5281/zenodo.22837936)
instead.
