...
the most recently archived version, which may be a release candidate rather than
the version on CRAN. To cite exactly what was used, take the DOI of that version
from the [Zenodo record](https://doi.org/10.5281/zenodo.22837936) instead.
