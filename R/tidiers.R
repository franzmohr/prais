...
#' Tidy
#'
#' @param x an object of class `prais`, usually, the result of a call to \code{\link{prais_winsten}}.
...
#' interval if \code{conf.int = TRUE}. Must be strictly greater than 0 and less than 1.
