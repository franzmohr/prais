...
#'
#' # The coefficient table, the AR(1) coefficient and the Durbin-Watson
#' # statistics of the original and of the transformed model
#' summary(pw)
#'
#' # The standard errors are those of 'vcov'
#' all.equal(sqrt(diag(vcov(pw))),
