...
resolves to the most recently archived version, which is not necessarily
the version you used or the one that is currently on CRAN. To cite
exactly what was used, take the DOI of that version from the [Zenodo
